...
typedef int (*scsi_funcptr_t)(scsi_device_t *, unsigned char *, void *, int);

static unsigned char scsi_commands[16][32] = {
	{ /* 00 */
		0x99, 0x05, 0x24, 0x7C, 0x20, 0xC5, 0xB0, 0xD8, 
		0x02, 0x30, 0x27, 0xC4, 0x00, 0x00, 0x00, 0x80, 
		0xF8, 0xFD, 0x0B, 0x00, 0x1F, 0xC5, 0xA0, 0xFC, 
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
	},
	{ /* 01 */
		0x3B, 0x8D, 0x3F, 0x7E, 0x00, 0x08, 0x10, 0x18, 
		0x10, 0x30, 0x20, 0xC4, 0x00, 0x00, 0x00, 0x00, 
	...
	{ /* 05 */
		...
		0xEC, 0x4C, 0x3E, 0x3D, 0x00, 0x00, 0x00, 0x00, 
	...
	{ /* 09 */
		...
		0x00, 0x30, 0x20, 0xC4, 0x00, 0x00, 0x00, 0x00, 
		0xC0, 0x00, 0x00, 0x00, 0x19, 0x00, 0x00, 0xFC, 
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
	},
	{ /* 10 */
		0x09, 0x00, 0x04, 0x08, 0x00, 0x45, 0x20, 0x08, 
	...
	{ /* 12 */
		...
		0x10, 0x30, 0x20, 0x04, 0x00, 0x00, 0x00, 0x00, 
...
static scsi_funcptr_t scsi_funcs[MAX_FUNC] = {
	...
	0,                                      /* 7d */
	0,                                      /* 7e */
	variable_length_cdb__more_than_16_bytes,/* 7f */
...
int scsi_process_command(scsi_device_t *dp, unsigned char *cdb, void *buffer, int size) {
	scsi_funcptr_t func;
	int num,byte,mask;
	...
	if (func) return func(dp, cdb, buffer, size);
